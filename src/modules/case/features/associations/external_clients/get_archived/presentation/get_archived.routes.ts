 ...
 * @openapi
 * /cases/external-clients/archive:
 *   get:
 *     security:
 *       - bearerAuth: []
 *     tags:
 ...
 *                 timestamp:
 *                   type: string
 *                   example: "2025-09-16T18:40:00.000Z"
 *                 path:
 *                   type: string
 *                   example: "/api/v1/cases/external-clients/get-archived"
 *                 data:
 *                   type: object
 *                   properties:
 *                     clients:
...
router.get("/", authenticateToken, ctrl.getArchived);
